...
<div class="cont1">
<h1>Add Product into Categories</h1>

<p class="confirm">${ confirm }</p>
<form action="/admin/categories/add/process" method="post">
    <p>
        <label>Product:</label>
        <select name="id_prod">
        <c:forEach items="${products}" var="prod">
        	<c:if test="${prod.user.id == user.id}">
    ...
    <input type="submit" value="Add" class="btn btn-primary ml-5 mt-5"/>

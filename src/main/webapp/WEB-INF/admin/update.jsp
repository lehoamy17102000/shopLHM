...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%> 
<h1>Category</h1>
<form:form action="/admin/categories/update/process" method="put" modelAttribute="category">
    	<form:hidden path="id" value="${ category.id }"/>
    <p class="form-group">
        <form:label path="name">Name:</form:label>
        <form:errors path="name"/>
        <form:input class="form-control" path="name" value="${ category.name }"/>
    </p>
    <input type="submit" value="Update" class="btn btn-primary ml-5 mt-5"/>
...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%> 
<h1>Product</h1>
<form:form action="/admin/products/update/process" method="put" modelAttribute="product">
    ...
    <p class="form-group">
        <form:label path="name">Name:</form:label>
        <form:errors path="name"/>
        <form:input class="form-control" path="name" value="${ product.name }"/>
    </p>
    <p class="form-group">
        <form:label path="url">Link image of product:</form:label>
        <form:errors path="url"/>
        <form:input class="form-control" path="url" value="${ product.url }"/>
    </p>
    <p class="form-group">
    ...
    <p class="form-group">
        ...
        <form:input class="form-control" type="number" path="price" value="${ product.price }"/>
    </p>
